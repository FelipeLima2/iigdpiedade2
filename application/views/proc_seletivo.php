              ...
              <div class="card-header">
                  ...
                  <div class="row justify-content-md-center">
                    <div class="col-md-auto">
                      <h3 class="card-title">Cadastro Entrevista Fictícia</h3>
                    </div>
                  </div>
              </div>
              <form method="post" action="<?php echo base_url('processo_seletivo/core'); ?>">
                <div class="card-body">
                  <div class="row justify-content-md-center">
                    <div class="col-5">
                  ...
                  <div class="row justify-content-md-center">
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for="dtnascimento">Vaga Desejada</label>
                        <select id="profissao" class="form-control"  name="profissao[]" multiple="multiple"></select>
                      </div>
                    </div>
                  </div>
